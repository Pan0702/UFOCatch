...
VECTOR3 CPlayer::CalcSuctionDisplacement(const float& moveTimeSecond, const VECTOR3& animalPos) const
{
    ...
    float heightDiff = coneTopPos - animalPos.y;
    float progress = 1.0f - (heightDiff / coneTopPos);
    ...
    float projectionFactorY0 = avoidZero((0 - animalPos.y) / (animalPos.y - coneTopPos));
